...
protocol CustomSwitchDelegate {
    func didChange(_ dooSwitch: CustomSwitch)
}
...
public class CustomSwitch: UIControl {
    ...
    @IBInspectable public var switchCornerRadius: CGFloat {
    ...
    @IBInspectable public var onThumbTintColor: UIColor = UIColor.white {
        didSet {
            self.thumbView.backgroundColor = isOn ? self.onThumbTintColor : self.offThumbTintColor
        }
    }
    @IBInspectable public var offThumbTintColor: UIColor = UIColor.white {
        didSet {
            self.thumbView.backgroundColor = isOn ? self.onThumbTintColor : self.offThumbTintColor
        }
    }
    ...
    var customSwitchDelegate: CustomSwitchDelegate? = nil
...
//        self.thumbView.backgroundColor = self.onthumbTintColor
    ...
    override open func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        //self.animate()
        self.customSwitchDelegate?.didChange(self)
...
extension CustomSwitch {
    ...
    public override func layoutSubviews() {
        ...
        if !self.isAnimating {
            self.layer.cornerRadius = self.bounds.size.height * self.switchCornerRadius
            self.backgroundColor = self.isOn ? self.onTintColor : self.offTintColor
...
extension CustomSwitch {
    ...
    fileprivate func setupLabels() {
        ...
        self.labelOff.text = localizeFor("off")
        self.labelOn.text = localizeFor("on")
