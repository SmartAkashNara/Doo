...
open class SwiftHSVColorPicker: UIView, ColorWheelDelegate, BrightnessViewDelegate {
    ...
    var delegateOfColorPicker: SwiftHSVColorPickerDelegate? = nil

    open var color: UIColor!
    var hue: CGFloat = 1.0
    var saturation: CGFloat = 1.0
    var brightness: CGFloat = 1.0
    var brightnessLimit: CGFloat = 0.18
    ...
    func hueAndSaturationSelected(_ hue: CGFloat, saturation: CGFloat) {
        ...
        delegateOfColorPicker?.colorPicked(self.color)
    }
    ...
    func brightnessSelected(_ brightness: CGFloat) {
        if brightness >= brightnessLimit{
            ...
            delegateOfColorPicker?.colorPickedWithBrightness(self.color)
        }
    }
}
