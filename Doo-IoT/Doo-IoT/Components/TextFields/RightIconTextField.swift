...
@IBDesignable class RightIconTextField: GenericTextField {
    ...
    override var disabled: Bool{
        didSet{
            ...
            rightIconButton.alpha = disabled ? 0.4 : 1.0
        }
    }
    ...
    private func setRightIcon() {
        ...
        self.rightIconButton.imageEdgeInsets = UIEdgeInsets(top: 6, left:0, bottom: 0, right: 0)
    ...
    func setRightIconUserInteraction(to value: Bool) {
        self.rightIconButton.isUserInteractionEnabled = value
    }
